...
// Buscar elementos dentro del localStorage, sin o encuentra, será un arreglo vacío
const todosArr = JSON.parse(localStorage.getItem('todos' )) || [];

// Funcion para actualizar los elementos
const actualizaTodos = (todosArr) => {
    const todosString = JSON.stringify(todosArr);
